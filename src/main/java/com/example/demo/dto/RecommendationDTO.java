...
public class RecommendationDTO {
    ...
    public RecommendationDTO(Long studentProfileId, Long skillId, String skillName,
                             Double gapScore, String priority, String recommendedAction, Instant generatedAt) {
